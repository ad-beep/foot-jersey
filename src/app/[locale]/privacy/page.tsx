    ...
    ? [
        {
          ...
          body: 'אנו אוספים מידע שאתה מספק לנו ישירות בעת ביצוע הזמנה: שם, כתובת דוא"ל, מספר טלפון, כתובת למשלוח וכתובת לחיוב. אנו אוספים גם נתוני שימוש אנונימיים כדי לשפר את חוויית האתר.',
        },
        {
          title: 'כיצד אנו משתמשים במידע',
          body: 'אנו משתמשים במידע שלך כדי לעבד ולמלא הזמנות, לתקשר איתך לגבי ההזמנה שלך, לשפר את השירותים שלנו, ולשלוח עדכונים על מוצרים חדשים — רק אם הסכמת לקבל אותם.',
        },
        {
          title: 'אבטחת מידע',
          body: 'אנו מיישמים אמצעי אבטחה סטנדרטיים בתעשייה כדי להגן על המידע האישי שלך. תשלומים מעובדים באופן מאובטח דרך PayPal ו-BIT — אנחנו לא שומרים פרטי כרטיס אשראי על שרתינו.',
        },
        {
          title: 'עוגיות',
          body: 'אנו משתמשים בעוגיות חיוניות לתפקוד האתר בלבד — עגלת קניות, העדפות שפה, ומצב התחברות. אין לנו עוגיות מעקב של צד שלישי.',
        },
        {
          title: 'שמירת מידע',
          body: 'אנו שומרים את המידע שלך כל עוד הוא נחוץ לעיבוד ההזמנות שלך ולעמידה בדרישות החוק. תוכל לבקש מחיקת המידע שלך בכל עת.',
        },
      ]
    : [
        {
          title: 'Information We Collect',
          body: 'We collect information you provide directly when placing an order: name, email address, phone number, shipping address, and billing address. We also collect anonymous usage data to improve the site experience.',
        },
        {
          title: 'How We Use Information',
          body: 'We use your information to process and fulfill orders, communicate with you about your order, improve our services, and send updates about new products — only if you opted in to receive them.',
        },
        {
          title: 'Data Security',
          body: 'We implement industry-standard security measures to protect your personal information. Payments are securely processed through PayPal and BIT — we do not store credit card details on our servers.',
        },
        {
          title: 'Cookies',
          body: 'We use essential cookies for site functionality only — shopping cart, language preferences, and login state. We do not use third-party tracking cookies.',
        },
        {
          title: 'Data Retention',
          body: 'We retain your information for as long as necessary to process your orders and comply with legal requirements. You can request deletion of your data at any time.',
        },
      ];
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        >
          ...
          <p className="text-sm mb-4" style={{ color: 'rgba(255,255,255,0.5)' }}>
            {isHe
              ? 'לשאלות בנושא פרטיות, פנו אלינו ישירות בוואטסאפ.'
              : 'For privacy questions, contact us directly on WhatsApp.'}
          </p>
          <a
