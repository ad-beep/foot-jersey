        ...
        <div className="max-w-[700px] mx-auto px-4 md:px-6 py-12">
          <div className="space-y-4">
            ...
            <a
              ...
              className={`flex items-center gap-5 p-6 rounded-xl transition-colors duration-200 border border-[var(--border)] hover:border-[#25D366] ${isHe ? 'flex-row-reverse' : ''}`}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center gap-5 p-6 rounded-xl transition-colors duration-200 border border-[var(--border)] hover:border-[#E1306C] ${isHe ? 'flex-row-reverse' : ''}`}
              style={{ backgroundColor: 'var(--steel)' }}
            >
              <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{ background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)' }}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center gap-5 p-6 rounded-xl transition-colors duration-200 border border-[var(--border)] hover:border-[#69C9D0] ${isHe ? 'flex-row-reverse' : ''}`}
              style={{ backgroundColor: 'var(--steel)' }}
            >
              <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{ backgroundColor: '#010101' }}>
