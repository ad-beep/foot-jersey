...
import { PackagePlus, ClipboardList, Ticket } from 'lucide-react';

export default function AdminDashboard() {
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-2xl font-bold mb-1">Admin Cockpit</h1>
      <p className="text-sm text-gray-400 mb-8">Manage products, orders, and promotions</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Create and manage promo codes</p>
          </div>
        </Link>
      </div>
    </div>
