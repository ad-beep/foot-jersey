...
export default function AdminDashboard() {
  ...
  const costBars = [
    ...
    { label: 'Ad Budget',   value: metrics.marketingILS,       color: '#a855f7' },
        ...
        <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-0">
            {[
              ...
              { dot: '#a855f7', label: `Ad Budget (${metrics.totalJerseys} jerseys × ₪${MARKETING_PER_JERSEY})`, value: metrics.marketingILS },
